...
<div class="content">
    ...
    <div class="action-bar">
        ...
        <a href="${pageContext.request.contextPath}/admin/taikhoan?action=new" class="btn btn-primary">Thêm tài khoản mới</a>
    </div>
    ...
    <table>
        ...
        <c:forEach var="taiKhoan" items="${taiKhoanList}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/admin/taikhoan?action=edit&soDienThoai=${taiKhoan.soDienThoai}" class="btn btn-warning">Sửa</a>
                    <a href="${pageContext.request.contextPath}/admin/taikhoan?action=delete&soDienThoai=${taiKhoan.soDienThoai}" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa?');">Xóa</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="info-section">
        ...
        <ul>
            <li>Thêm tài khoản mới bằng cách nhấn nút "Thêm tài khoản mới" và điền đầy đủ thông tin.</li>
            <li>Sửa hoặc xóa tài khoản bằng các nút "Sửa" và "Xóa" tương ứng.</li>
        ...
        <ul>
            ...
            <li>Đảm bảo bảo mật thông tin tài khoản khi thực hiện chỉnh sửa hoặc xóa.</li>
        </ul>
    </div>
</div>

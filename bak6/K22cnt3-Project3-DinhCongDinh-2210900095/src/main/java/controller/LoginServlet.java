        ...
        try {
            ...
            if (vaiTro != null) {
                ...
                if (congDan != null) {
                    ...
                    session.setAttribute("ngaySinh", congDan.getNgaySinh()); // Thêm ngày sinh
                    session.setAttribute("gioiTinh", congDan.getGioiTinh()); // Thêm giới tính
                    ...
                    session.setAttribute("ngayCap", congDan.getNgayCap()); // Thêm ngày cấp
                    session.setAttribute("ngayHetHan", congDan.getNgayHetHan()); // Thêm ngày hết hạn
                }
